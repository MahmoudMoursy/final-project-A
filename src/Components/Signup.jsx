...
function Signup() {
    ...
    function save(data) {
        console.log(data);
        nav('/Home', { replace: true, state: { data: "hi from signup" } });
    }
                ...
                <div className="row justify-content-around mt-md-0 m-lg-5">
                    ...
                    <div className="col-md-6 col-lg-4">
                        <form
                            ...
                            className="border border-1 border-black bg-white rounded-5 p-3"
                        >
                            <img
                                src={logo} alt="img" className="w-25 mx-auto d-block mb-4" />
                            <p className="text-black text-center mb-4 fw-bold">
                                Please Sign Up To Continue To App
                            </p>
                            <div
                                className="d-flex justify-content-around p-2 rounded-4 mb-3"
                                style={{ backgroundColor: "rgb(216, 220, 220)" }}
                            >
                                <button type="button" className="btn py-2 px-5 rounded-3 fw-bold" onClick={() => nav('/login')}>
                                    Login
                                </button>
                            ...
                            <div className="mb-3">
                                <label htmlFor="name" className="text-black fw-bold">
                                    Your Name
                                </label>
                                <input
                                    {...register('name')}
                            ...
                            <div className="mb-3">
                                <label htmlFor="email" className="text-black fw-bold">
                                    Email
                                </label>
                                <input
                                {...register('email')}
                            ...
                            <div className="mb-3">
                                <label htmlFor="password" className="text-black fw-bold">
                                    Password
                                </label>
                                <input
                                    type="password"
                            ...
                            <div className="mb-3">
                                <label htmlFor="Confirm" className="text-black fw-bold">
                                    Confirm Password
                                </label>
                                <input
                                    type="password"
